...
function Hero() {
  return (
    <div className="relative bg-cover bg-center bg-[url('/assets/images/banner.jpg')] bg-opacity-60 flex flex-col justify-center items-center px-8 sm:px-4 bg-blend-overlay" style={{ height: "calc(100vh - 60px)" }}>
